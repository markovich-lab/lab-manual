...
Writing: Preferably via [Overleaf](https://www.overleaf.com) or GoogleDoc, but MS Word documents can also be shared. Word documents should always have your last name as the first part of the file name and a version number (e.g., please no "markovich_thesis_v1.docx").

We also share our institutional knowledge through our lab-manual [Discussions page](https://github.com/markovich-lab/lab-manual/discussions). This is a community-driven resource for ideas, troubleshooting, etc. Please contribute!
...
Where to find shared resources: - Sharepoint - You will be given access to the shared drive during onboarding, take a look at the Lab Meetings folder to find Lab Meeting Notes for each semester - GitHub - markovich-lab is the shared GitHub account for the lab - lab-manual - This repository contains the lab manual, and the [Wiki](https://github.com/markovich-lab/lab-manual/wiki/Group-Meeting-Schedule) has the lab meeting schedule.
