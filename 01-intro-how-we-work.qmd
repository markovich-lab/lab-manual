...
Writing: Preferably via [Overleaf](https://www.overleaf.com) or GoogleDoc, but MS Word documents can also be shared. Word documents should always have your last name as the first part of the file name and a version number (e.g., "markovich_thesis_v1.docx").
