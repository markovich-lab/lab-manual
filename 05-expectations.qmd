...
Course of study: Work with Katie when crafting and revisiting your individual mentoring plans to identify classes that you will take during your academic program. The UNM Water Resources program maintains a helpful list of classes on their [website](https://wrp.unm.edu/current-students/index.html). You should also consider taking a course at NM Tech--they have a fantastic hydrology program. A list of classes that lab members have taken, and suggested course of study schedule for Fay lab grad students can be found in Chapter \@ref(courses).  
