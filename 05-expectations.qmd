...
In addition to agreeing to follow our communities codes of conduct and the university academic integrity policy (Chapter \@ref(culture)), we expect everyone in the group to echo our lab culture (Chapter \@ref(culture)). 
...
Before registering for each semester, you are required to meet with your advisor (Katie) to discuss plans for the forthcoming semester (classes, activities, etc.).  

Course of study: The UNM EPS graduate program requires students to meet with their advisor in their first week to make a list of classes that you will take during your academic program. This will vary based on how many credits you can transfer from undergrad or a previous graduate degree.  

The UNM Water Resources program maintains a helpful list of classes on their [website](https://wrp.unm.edu/current-students/index.html). You should also consider taking a course at NM Tech--they have a fantastic hydrology program. 

A list of classes that lab members have taken, and suggested course of study schedule for Markovich lab grad students can be found in Chapter \@ref(courses).  (todo)
...
Although the grad student / postdoc is your primary contact, always feel like you can reach out to both [Katie](mailto:kmarkovich@unm.edu) as lab PI. We are excited to help you use your position in the lab to further your career goals and want to work with you to help you achieve them.  
